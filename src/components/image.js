 ...
 * @param {boolean} external if the image is external or local. default is false.
 ...
 */
export default function Image({ path, external = false, styles, classes, mode = 'contain', ...extras }) {
    function getMode() {
