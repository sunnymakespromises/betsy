...
async function getData(category = null, currentUser = null) {
    ...
    async function fetchData(response) {
        ...
        const params = {
            ...
            events: {
                table: 'Events',
                attributes: ['id', 'name', 'competition', 'competitors', 'sport', 'is_outright', 'start_time', 'slip_count', 'odds', 'is_completed'],
